<template>
    <div class="absolute flex flex-col justify-between px-5 pt-10 pb-[16px] md:pb-[24px] z-email w-full h-full top-0 left-0 transform will-change-trasform transition duration-500 bg-white"
