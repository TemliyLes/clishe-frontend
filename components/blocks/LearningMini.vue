    ...
    <div class="my-12 md:my-24">
        <div class="md:flex gap-4">
            <div class="basis-1/2 shrink-0">
                <h5 class="monster text-main text-[24px] md:text-[42px]">Take pictures<br />with your eyes</h5>
                <SimpleText class="mt-4 md:mt-6 pr-4">Это вариант самостоятельного изучения материала в формате
                    закрытого
                    канала.
                </SimpleText>
                <img hidden v-loaded class="sticky w-full sm:top-5 my-4 md:my-9 sm:my-0 h-[388px] md:h-auto"
                    src="/public/learn.jpg" />
                <div class="flex gap-4 basis-1/2 flex-wrap mt-9">
            ...
            <div class="flex gap-2 md:gap-4">
                <img class=" w-[49%]" src="/public/minilearn1.jpg" alt="">
                <img class="w-[49%]" src="/public/minilearn2.jpg" alt="">
            </div>
        </div>
    </div>
</template>
